...
INSERT INTO dbo.RefAmlReport (
	...
	1268,
	'S844 DP Transaction Many to One - CDSL & NSDL',
	'System',
	GETDATE(),
	'System',
	GETDATE(),
	...
	@RefAlertRegisterCaseTypeId,
	0, 
	'S844DPTransactionManyToOneCDSLAndNSDL',
	1,
	@FrequencyFlagRefEnumValueId,
	844
)
...
SELECT @AmlReportId = RefAmlReportId FROM dbo.RefAmlReport WHERE [Name] = 'S844 DP Transaction Many to One - CDSL & NSDL'
...
INSERT INTO dbo.SysAmlReportSetting (
	...
	'0',
	1,
	'No of In transactions during the month =>',
	2,
	GETDATE(),
	'System',
	GETDATE(),
	...
	'0',
	1,
	'Total In Transactions Value during the month  =>',
	3,
	GETDATE(),
	'System',
	GETDATE(),
...
SELECT @RefAmlReportId = RefAmlReportId FROM dbo.RefAmlReport WHERE [Name] = 'S844 DP Transaction Many to One - CDSL & NSDL'
...
INSERT INTO dbo.RefProcess (
	...
	'S844 DP Transaction Many To One - CDSL & NSDL',
	'TSS.SmallOfficeWeb.ManageData.Processes.AML.Reports.S844DPTransactionManyToOneCDSLAndNSDL',
...
GO
--WEB-70762-END-RC
--exec AML_GetDPTransactionManyToOneCDSLAndNSDL '04-22-2022',1268
--WEB-70762-START-RC
GO
