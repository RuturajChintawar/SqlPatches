...
'Watchlist_MCA_Company_Defaulter_List.zip','C:\TssFileDownload\Other_Watchlist_MCA_Company_Defaulter_List',0,0,0,'Pickup','TrackWizzFeeds',NULL,23
GO
...
GO
EXEC dbo.RefWebFileLocation_InsertIfNotExists 'Other','NSE_REGULATORY_DEFAULTING_CLIENTS','sftp','/TSS/Screening/NSE_REGULATORY_DEFAULTING_CLIENTS/Latest/',
'NSE_REGULATORY_DEFAULTING_CLIENTS.zip','C:\TssFileDownload\Other_CBI_Wanted_Person_Rewards',0,0,0,'Pickup','TrackWizzFeeds',NULL,'J1421',34
GO
...
GO
EXEC dbo.RefWebFileLocation_InsertIfNotExists 'Other','FL78_TrackWizz_Screening_Standard_Feed','sftp','/TSS/Screening/MCX Expelled Members/Latest/t',
...
--WEB-64830-RC-END
update core
set Name='TrackWizzFeeds'
from RefFtpSite core 
where core.RefFtpSiteId=66