--WEB-74204-RC START
GO
CREATE PROCEDURE [dbo].[AML_GetS43SynchronizedTrading1DayFnO]
(
...
SET
	Threshold1DisplayName = 'Client Sync TO Instrument type Day >=',
	Threshold2DisplayName = 'Difference in Sec<='
WHERE [Name] = 'S43 Synchronized Trading 1 Day FnO'
GO
--WEB-74204-RC END